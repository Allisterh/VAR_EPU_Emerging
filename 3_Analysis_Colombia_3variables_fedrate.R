...
#colombia_epu <- window(fedrate.1997, start = c(1998,1))
#colombia_fdi <- window(colombia_fdi, start = c(1998,1))
#colombia_pi <- window(colombia_pi, start = c(1998,1))

# FDI: First ordering ####
Y <- cbind(fedrate.1997, colombia_epu, colombia_fdi)
...
# Check: IRFs
#irf1.1 <- irf(SVAR , impulse = "fedrate.1997", response = "colombia_epu", n.ahead = 8, ortho = TRUE, runs=1000, seed=101)
...
# FDI: Second ordering ####
Y <- cbind(fedrate.1997, colombia_fdi, colombia_epu)
Y.d <- diff(Y) # Data in differences
#plot(Y.d)
...
# PI: First ordering ####
Y <- cbind(fedrate.1997, colombia_epu, colombia_pi)
Y.d <- diff(Y) # Data in differences
#plot(Y.d)
...
# PI: Second ordering ####
Y <- cbind(fedrate.1997, colombia_pi, colombia_epu)
Y.d <- diff(Y) # Data in differences
#plot(Y.d)
